...
public class ProbabilityExtremeInputsTests
{
	...
	private final int Trials = 50000; //Fewer tests on this one; extreme inputs is time consuming.
	...
	private final int MinInputs = 2000;
	private final int MaxInputs = 3000;

	//Range of weights each item can have.
	private final int MinWeight = 3;
	private final int MaxWeight = 6;
